...
class MissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mission" do
    assert_difference('Mission.count') do
      post missions_url, params: { mission: { organizer_id: @mission.organizer_id, status: @mission.status, task_id: @mission.task_id } }
    end
  ...
  test "should update mission" do
    patch mission_url(@mission), params: { mission: { organizer_id: @mission.organizer_id, status: @mission.status, task_id: @mission.task_id } }
